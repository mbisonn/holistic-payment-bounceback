...
-- 9. Create order_bumps table if it doesn't exist (to fix the error)
...
BEGIN
    ...
    FOR r IN 
        ...
        ORDER BY tablename
    LOOP
        RAISE NOTICE 'Table: %.% | RLS: % | Policies: %', r.schemaname, r.tablename, r.rls_enabled, r.policy_count;
    END LOOP;
    
    RAISE NOTICE '==================';
    RAISE NOTICE 'All RLS restrictions removed! All users now have unrestricted access.';
END $$;
