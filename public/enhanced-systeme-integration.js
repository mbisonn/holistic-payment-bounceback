...
/**
 * Enhanced Systeme.io to Lovable App Integration Script
 * Synchronizes cart data via SKU matching and handles checkout flow
 */

(function() {
  // Configuration for products and URL paths
  const config = {
    orderFormUrl: "https://www.teneraholisticandwellness.com/order-payment",
    syncCartUrl: "https://xjfkeblnxyjhxukqurvc.functions.supabase.co/functions/sync-cart", // Updated to correct endpoint
    ordersApiUrl: "https://xjfkeblnxyjhxukqurvc.functions.supabase.co/functions/orders",
    lovableAppUrl: "https://e84d0afb-f51a-49f1-b3e0-2d35cebef2bd.lovableproject.com", // Current Lovable app URL
    currency: "₦",
    debug: true,
    products: {
      "blood-booster": { 
  ...
  async function proceedToCheckout() {
    ...
    try {
      // Send to current window and all potential iframe targets
      const messageData = {
